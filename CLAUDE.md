...
Project rules for Claude Code. Keep this file focused on non-negotiable architecture constraints; use the linked skills and `ai/*.md` files for implementation workflow.
