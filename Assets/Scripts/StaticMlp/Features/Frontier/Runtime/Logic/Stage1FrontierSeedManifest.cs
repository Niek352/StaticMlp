...
{
    public static class Stage1FrontierSeedManifest
    {
        private const ushort MONSTER_BEHAVIOR_ID = 1;
        private const ushort PEACEFUL_BUILDER_BEHAVIOR_ID = 2;

        private static readonly Stage1FrontierBotSpawnSeed[] INITIAL_BOT_SPAWNS =
        {
        ...
        public static Stage1FrontierSeed CreateResource()
        {
            return new Stage1FrontierSeed(
                INITIAL_BOT_SPAWNS,
