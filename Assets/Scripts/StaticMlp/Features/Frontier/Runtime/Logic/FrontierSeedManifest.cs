...
{
    public static class FrontierSeedManifest
    {
        private const ushort MONSTER_BEHAVIOR_ID = 1;
        private const ushort PEACEFUL_BUILDER_BEHAVIOR_ID = 2;

        private static readonly FrontierBotSpawnSeed[] INITIAL_BOT_SPAWNS =
        {
        ...
        public static FrontierSeed CreateResource()
        {
            return new FrontierSeed(
                INITIAL_BOT_SPAWNS,
