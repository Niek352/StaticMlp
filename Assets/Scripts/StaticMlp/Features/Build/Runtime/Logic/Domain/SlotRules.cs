...
namespace StaticMlp.Features.Build
{
    public static class SlotRules
    {
        ...
        public static void ValidateModuleSupportsSlotKind(in BuildModuleDefinition module, EquipmentSlotKind requestedKind)
        {
        ...
        public static void ValidateModuleCatalog(IReadOnlyList<BuildModuleDefinition> definitions)
        {
