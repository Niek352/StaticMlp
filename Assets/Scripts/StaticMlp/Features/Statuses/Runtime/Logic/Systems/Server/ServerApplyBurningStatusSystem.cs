...
{
    public sealed class ServerApplyBurningStatusSystem : ISystem
    {
        ...
        {
            _effects.Clear();
            foreach (var effect in SW.Query<All<EffectTag, AddStatusEffectTag, BurningStatus, EffectSource, EffectTarget, EffectRequestId, AddStatusSpec, EffectChainData>, None<EffectProcessedTag, EffectRejectedTag>>().Entities())
