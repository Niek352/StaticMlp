...
namespace StaticMlp.Features.Progression
{
    ...
    public partial struct ProgressionState : IComponent, IComponentConfig<ProgressionState>,
        ITrackableAdded, ITrackableChanged, ITrackableDeleted
    {
        ...
        public ProgressionState(SettlementAnchorId anchorId, uint appliedFlagsMask)
        {
        ...
        public ComponentTypeConfig<ProgressionState> Config() =>
