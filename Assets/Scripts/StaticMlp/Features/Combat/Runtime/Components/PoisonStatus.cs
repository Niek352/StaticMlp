...
namespace StaticMlp.Features.Combat
{
    ...
    public struct PoisonStatus : IComponent, IComponentConfig<PoisonStatus>, ITrackableAdded, ITrackableChanged, ITrackableDeleted
    {
        ...
        public ComponentTypeConfig<PoisonStatus> Config() =>
            new(guid: new Guid("ff09138f-bfb8-4a58-8d29-bc065c1b9451"));
