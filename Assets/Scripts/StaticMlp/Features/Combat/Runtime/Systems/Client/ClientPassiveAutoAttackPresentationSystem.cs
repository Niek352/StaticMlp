...
namespace StaticMlp.Features.Combat
{
    public sealed class ClientPassiveAutoAttackPresentationSystem : ISystem
    {
        ...
        private void DecayHighlights(CombatAutoAttackConfig config, float deltaTime)
        {
        ...
        private void CollectNewShots(CombatAutoAttackConfig config)
        {
            _shots.Clear();
        ...
        private void ApplyShots(CombatAutoAttackConfig config)
        {
        ...
        private void ApplyCurrentTargetHighlights(CombatAutoAttackConfig config)
        {
