...
namespace StaticMlp.Features.Combat
{
    public sealed class ClientDamageFeedbackPresentationSystem : ISystem
    {
        ...
        private static void DecayExistingFeedback(CombatAutoAttackConfig config, float deltaTime)
        {
        ...
        private static void ApplyNewFeedback(CombatAutoAttackConfig config)
        {
