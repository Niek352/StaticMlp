...
namespace StaticMlp.Features.Loadout
{
    ...
    public partial struct BossPreparedLoadoutSnapshot : IComponent, IComponentConfig<BossPreparedLoadoutSnapshot>,
        ITrackableAdded, ITrackableChanged, ITrackableDeleted
    {
        ...
        public LoadoutArchetypeId ArchetypeId => new(ArchetypeIdValue);
        public LoadoutModuleId PrimaryModuleId => new(PrimaryModuleIdValue);

        public ComponentTypeConfig<BossPreparedLoadoutSnapshot> Config() =>
            new(guid: new Guid("641d2d15-83f0-4328-8b35-4063e914bc61"));

        public void Apply(in PreparedLoadoutSnapshot snapshot)
        {
