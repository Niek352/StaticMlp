...
{
    public static class ActiveModuleLoadoutQuery
    {
        public static LoadoutModuleId Get(in ActiveModuleLoadout loadout, EquipmentSlotKind slotKind, int slotIndex)
        {
            switch (slotKind)
            {
        ...
        public static bool Contains(in ActiveModuleLoadout loadout, LoadoutModuleId moduleId)
        {
        ...
        public static void CopyActiveModules(in ActiveModuleLoadout loadout, List<LoadoutModuleId> results)
        {
            results.Clear();
        ...
        private static void AddIfSet(List<LoadoutModuleId> results, LoadoutModuleId moduleId)
        {
            if (moduleId.Value != 0)
