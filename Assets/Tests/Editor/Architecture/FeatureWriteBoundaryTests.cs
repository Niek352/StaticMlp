...
namespace StaticMlp.Tests.Architecture
{
    public sealed class FeatureWriteBoundaryTests
    {
        ...
        private static readonly Violation[] Baseline =
        {
            ...
            new Violation("ReplicationMut.Mut", "Assets/Scripts/StaticMlp/Features/Progression/Runtime/Logic/ServerStage1BossPreparationProgressionSystem.cs", 46, "BossBuildPreparationState", "Progression", "Build"),
            new Violation("ReplicationMut.Mut", "Assets/Scripts/StaticMlp/Features/Progression/Runtime/Logic/ServerStage1BossPreparationProgressionSystem.cs", 53, "BossPreparedBuildSnapshot", "Progression", "Build"),
