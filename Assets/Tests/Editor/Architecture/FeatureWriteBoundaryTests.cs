...
namespace StaticMlp.Tests.Architecture
{
    public sealed class FeatureWriteBoundaryTests
    {
        ...
        private static readonly Violation[] Baseline =
        {
            ...
            new Violation("ReplicationMut.Mut", "Assets/Scripts/StaticMlp/Features/Buildings/Runtime/Factories/ConstructionSiteFactory.cs", 52, "ConstructionSiteState", "Buildings", "Settlement"),
            new Violation("ReplicationMut.Mut", "Assets/Scripts/StaticMlp/Features/Buildings/Runtime/Factories/ConstructionSiteFactory.cs", 60, "ConstructionSiteState", "Buildings", "Settlement"),
            new Violation("ReplicationMut.Mut", "Assets/Scripts/StaticMlp/Features/Buildings/Runtime/Factories/ConstructionSiteFactory.cs", 61, "ConstructionProgress", "Buildings", "Settlement"),
            ...
            new Violation("ReplicationMut.Mut", "Assets/Scripts/StaticMlp/Features/Buildings/Runtime/Requests/BuildConstructionHandler.cs", 38, "ConstructionProgress", "Buildings", "Settlement"),
            ...
            new Violation("ReplicationMut.Mut", "Assets/Scripts/StaticMlp/Features/Buildings/Runtime/Requests/DepositConstructionResourcesHandler.cs", 69, "ConstructionSiteState", "Buildings", "Settlement"),
