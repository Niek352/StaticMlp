...
namespace StaticMlp.Tests.Architecture
{
    public sealed class FeatureWriteBoundaryTests
    {
        ...
        private static readonly Violation[] Baseline =
        {
            ...
            new Violation("ReplicationMut.Mut", "Assets/Scripts/StaticMlp/Features/Buildings/Runtime/Factories/ConstructionSiteFactory.cs", 53, "ConstructionSiteState", "Buildings", "Settlement"),
            new Violation("ReplicationMut.Mut", "Assets/Scripts/StaticMlp/Features/Buildings/Runtime/Factories/ConstructionSiteFactory.cs", 54, "ConstructionResources", "Buildings", "Settlement"),
            new Violation("ReplicationMut.Mut", "Assets/Scripts/StaticMlp/Features/Buildings/Runtime/Factories/ConstructionSiteFactory.cs", 62, "ConstructionSiteState", "Buildings", "Settlement"),
            new Violation("ReplicationMut.Mut", "Assets/Scripts/StaticMlp/Features/Buildings/Runtime/Factories/ConstructionSiteFactory.cs", 64, "ConstructionProgress", "Buildings", "Settlement"),
            ...
            new Violation("ReplicationMut.Mut", "Assets/Scripts/StaticMlp/Features/Buildings/Runtime/Requests/DepositConstructionResourcesHandler.cs", 61, "SettlementSharedResources", "Buildings", "Settlement"),
            new Violation("ReplicationMut.Mut", "Assets/Scripts/StaticMlp/Features/Buildings/Runtime/Requests/DepositConstructionResourcesHandler.cs", 67, "ConstructionSiteState", "Buildings", "Settlement"),
            new Violation("ReplicationMut.Mut", "Assets/Scripts/StaticMlp/Features/Buildings/Runtime/Requests/DepositConstructionResourcesHandler.cs", 68, "ConstructionResources", "Buildings", "Settlement"),
            new Violation("ClientProjection.Mut", "Assets/Scripts/StaticMlp/Features/Buildings/Runtime/Requests/DepositConstructionResourcesProjector.cs", 43, "SettlementSharedResources", "Buildings", "Settlement"),
            new Violation("ClientProjection.Mut", "Assets/Scripts/StaticMlp/Features/Buildings/Runtime/Requests/DepositConstructionResourcesProjector.cs", 49, "ConstructionSiteState", "Buildings", "Settlement"),
            new Violation("ClientProjection.Mut", "Assets/Scripts/StaticMlp/Features/Buildings/Runtime/Requests/DepositConstructionResourcesProjector.cs", 50, "ConstructionResources", "Buildings", "Settlement"),
