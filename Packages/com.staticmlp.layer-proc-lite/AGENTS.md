...
When changing LayerProcLite's architecture, public semantics, allowed dependencies, package boundary, or ownership model, update this `AGENTS.md` in the same change.
