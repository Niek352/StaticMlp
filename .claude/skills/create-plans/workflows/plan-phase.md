...
**Key insight:** PLAN.md IS the prompt that Agent executes. Not a document that
...
- Agent automated work needing visual/functional verification? → checkpoint:human-verify
...
Tasks are instructions for Agent, not Jira tickets.
</anti_patterns>
...
- [ ] Tasks are specific enough for Agent to execute
