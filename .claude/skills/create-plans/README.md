...
**Hierarchical project planning optimized for solo developer + Agent**

Create executable plans that Agent can run, not enterprise documentation that sits unused.

## Philosophy

**You are the visionary. Agent is the builder.**
...
- `with-agent-sdk` - Agent Agent SDK apps
...
Domain skills are created with [create-skills](../create-skills/) skill.
...
Planning for ONE person (you) and ONE implementer (Agent). No team coordination, stakeholder management, or enterprise processes.
