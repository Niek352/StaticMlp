...
1. Place the contract in the feature `Runtime/Logic/Components`, legacy `Runtime/Components`, or `Runtime/Contracts/Components` bucket according to `.claude/skills/staticmlp-code-writing/SKILL.md`.
