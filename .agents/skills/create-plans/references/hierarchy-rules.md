...
ROADMAP.md        ← Structure (phases)
    ↓
phases/XX/PLAN.md ← Implementation (Agent-executable)
    ↓
...
**Purpose**: Define Agent-executable tasks
**Audience**: Agent (the implementer)
...
**Audience**: Agent (via create-meta-prompts)
...
<cross_phase_context>
When planning Phase N, Agent should understand:
